...
export const products = [
  { id: 'prod_1001', categoryId: 'cat_phone', name: '星舷 X1 Pro 旗舰手机', price: 4999, marketPrice: 5399, stock: 36, sales: 268, published: true, tags: ['新品', '热卖'], specs: ['曜石黑 256G', '深海蓝 512G'], cover: 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?auto=format&fit=crop&w=900&q=80', description: '6.8 英寸高刷屏，旗舰影像系统，支持全天候 AI 场景优化。', detail: '采用新一代影像模组和大容量电池，适合摄影、游戏与重度办公用户。' },
  { id: 'prod_1002', categoryId: 'cat_phone', name: '星舷 Pad Air 平板电脑', price: 2899, marketPrice: 3199, stock: 58, sales: 155, published: true, tags: ['办公', '轻薄'], specs: ['银色 128G', '灰色 256G'], cover: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&w=900&q=80', description: '轻薄机身搭配手写笔生态，兼顾娱乐、学习与移动办公。', detail: '支持多任务分屏、磁吸键盘与高色域显示，适合课程笔记和演示。' },
  { id: 'prod_1003', categoryId: 'cat_home', name: '云岛智能空气净化器', price: 1499, marketPrice: 1799, stock: 42, sales: 93, published: true, tags: ['家用', '净化'], specs: ['标准版', '除醛增强版'], cover: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?auto=format&fit=crop&w=900&q=80', description: '三重滤芯系统，支持手机 App 联动查看空气质量。', detail: '适合卧室和客厅使用，低噪模式下夜间依旧安静。' },
  { id: 'prod_1004', categoryId: 'cat_home', name: '极光扫拖一体机器人', price: 2299, marketPrice: 2599, stock: 24, sales: 176, published: true, tags: ['清洁', '智能'], specs: ['基础版', '自动上下水版'], cover: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?auto=format&fit=crop&w=900&q=80', description: '自动建图避障，解放日常清洁时间。', detail: '支持智能分区清扫，拖布自动回洗，适合大户型家庭。' },
  { id: 'prod_1005', categoryId: 'cat_beauty', name: '琉光修护精华套组', price: 699, marketPrice: 799, stock: 80, sales: 322, published: true, tags: ['护肤', '礼盒'], specs: ['30ml 双瓶装', '50ml 礼盒装'], cover: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=900&q=80', description: '修护维稳型护肤套组，适合日常保湿提亮。', detail: '礼盒包装精致，节日送礼与自用都很合适。' },
  { id: 'prod_1006', categoryId: 'cat_beauty', name: '雾感持妆彩妆盘', price: 239, marketPrice: 299, stock: 120, sales: 409, published: true, tags: ['彩妆', '热门'], specs: ['暖调大地色', '冷调灰粉色'], cover: 'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?auto=format&fit=crop&w=900&q=80', description: '一盘满足通勤与约会妆容，粉质细腻易晕染。', detail: '高显色不飞粉，适合新手快速完成眼妆。' },
  { id: 'prod_1007', categoryId: 'cat_office', name: '墨羽机械键盘', price: 399, marketPrice: 459, stock: 47, sales: 146, published: true, tags: ['键盘', '办公'], specs: ['青轴', '静音红轴'], cover: 'https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?auto=format&fit=crop&w=900&q=80', description: '紧凑布局与高颜值配色兼具，手感稳定。', detail: '适合代码编写、文案创作与日常娱乐。' },
  { id: 'prod_1008', categoryId: 'cat_office', name: '星空降噪会议耳机', price: 899, marketPrice: 1099, stock: 65, sales: 198, published: true, tags: ['会议', '蓝牙'], specs: ['白色', '黑色'], cover: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=900&q=80', description: '双麦降噪，适合远程办公与通勤佩戴。', detail: '支持多设备连接和长续航，会议沟通更高效。' },
  { id: 'prod_1009', categoryId: 'cat_wear', name: '追风智能运动手表', price: 1199, marketPrice: 1399, stock: 39, sales: 211, published: true, tags: ['运动', '健康'], specs: ['夜幕黑', '薄荷绿'], cover: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=900&q=80', description: '支持多种运动模式与心率睡眠监测。', detail: '适合跑步、骑行、健身等日常运动场景。' },
  { id: 'prod_1010', categoryId: 'cat_wear', name: '疾光开放式耳机', price: 599, marketPrice: 699, stock: 88, sales: 267, published: true, tags: ['蓝牙', '轻量'], specs: ['曜石黑', '云雾白'], cover: 'https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?auto=format&fit=crop&w=900&q=80', description: '开放式佩戴更安全，长时间佩戴无明显压迫。', detail: '适合晨跑、通勤和办公室场景使用。' },
  { id: 'prod_1011', categoryId: 'cat_phone', name: '影像大师便携相机', price: 3699, marketPrice: 4099, stock: 18, sales: 67, published: true, tags: ['摄影', '便携'], specs: ['银黑拼色', '纯黑版'], cover: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=900&q=80', description: '轻便机身配合高像素传感器，记录旅途灵感。', detail: '适合城市随拍与 Vlog 创作，色彩表现自然。' },
  { id: 'prod_1012', categoryId: 'cat_home', name: '暮云香薰夜灯', price: 199, marketPrice: 239, stock: 96, sales: 305, published: false, tags: ['氛围', '居家'], specs: ['白橙暖光', '深灰冷光'], cover: 'https://images.unsplash.com/photo-1602874801007-bd458bb1b8b6?auto=format&fit=crop&w=900&q=80', description: '打造放松睡眠氛围的桌面夜灯香薰组合。', detail: '后台可演示下架商品对前台列表的实时联动效果。' },
];
